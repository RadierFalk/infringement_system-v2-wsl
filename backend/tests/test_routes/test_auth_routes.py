...
def test_login_wrong_password(client, admin_user):
    response = client.post("/auth/login", json={"username": "admin.teste", "password": "senha_errada"})
...
def test_login_nonexistent_user(client):
    response = client.post("/auth/login", json={"username": "nao.existe", "password": "qualquer"})
