...

  {
    ...
    children: [
...

      {
        ...
        component: OccurrencesSearchComponent,
      },

      {
        ...
        children: [
          // O guard decide o destino:
          // super_admin -> occurrences
          // admin -> occurrences/list.
          // Precisa de um component aqui porque o Angular exige um
          // component para a rota existir; ele nunca chega a renderizar,
          // pois o guard redireciona antes.

          {
            path: '',
            pathMatch: 'full',
            component: OccurrencesListComponent,
            canActivate: [managementLandingGuard],
          },
          ...
          // Tile-page (Add/List) só faz sentido pra quem pode Add
          // -> só super_admin
          {
            path: 'occurrences',
          ...
          // Criar ocorrência continua só super_admin
          {
            ...
            component: OccurrenceAddComponent,
            canActivate: [superAdminGuard],
          },
        ],
      },
